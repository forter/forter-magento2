 ...
 */
class OrderPlacementTestCheckmoPreAndPostAuth extends TestCase
{
     ...
     */
    public function testOrderApproveCheckmoPaymentPreAndPostAuthorization()
    {
    ...
    public static function loadSettingsFixture()
    {
        $objectManager = Bootstrap::getObjectManager();
        $objectManager->get(\Magento\Eav\Model\Config::class)->clear();
        require __DIR__ . '/fixtures/settings/env.php';
    }
