 ...
 */
class OrderPlacementTestBraintreePreAndPostAuth extends TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    private function saveForterConfigSettings()
    {
        ...
        $configValuesForter = [
            ...
            'forter/immediate_post_pre_decision/pre_post_select' => '4',
        ];
    ...
    private function saveBraintreeConfigSettings()
    {
        $configValuesBraintree = [
            ...
            'payment/braintree/sandbox_merchant_id' => 't6zvx2js3gt4jj85',
            'payment/braintree/sandbox_public_key' => 't6v2y24h7twb9zyp',
            'payment/braintree/sandbox_private_key' => '754181df1e828fb25be93e6548e4bcf5',
     ...
     */
    public function testOrderApproveBraintreePaymentPreAndPostAuthorization()
    {
