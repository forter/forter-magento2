 ...
 */
class OrderPlacementTestBraintreePostAuth extends TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    private function saveForterConfigSettings()
    {
        ...
        $configValuesForter = [
            ...
            'forter/immediate_post_pre_decision/pre_post_select' => '2',
        ];
     ...
     */
    public function testOrderApproveWithBraintreePaymentPostAuthorization()
    {
