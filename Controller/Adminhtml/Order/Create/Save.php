...
namespace Forter\Forter\Controller\Adminhtml\Order\Create;

use Magento\Sales\Controller\Adminhtml\Order\Create\Save as SaveOrder;

class Save extends SaveOrder
{
    /**
    ...
    public function execute()
    {
        ...
        try {
            ...
            $forterNumber = $this->getRequest()->getPost('forter_client_webid');
